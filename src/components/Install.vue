<template>
 ...
 <div class="text-2xl font-bold pt-2">Create simple minima server</div>
  <div class="mockup-code bg-code w-1/3">
  <pre ><code v-html="setupRelatedCode"></code></pre>
 </div>
  <a
   class="btn btn-primary text-4xl border border-transparent tansition ease-in-out transform hover:-translate-y-1 hover:scale-105 duration-200 normal-case"
